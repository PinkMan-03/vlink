...
- [接收顺序策略](#接收顺序策略)
- [所有权策略](#所有权策略)
- [Deadline 配置](#deadline-配置)
- [Lifespan 配置](#lifespan-配置)
- [延迟预算配置](#延迟预算配置)
- [资源限制配置](#资源限制配置)
- [VLink 扩展字段](#vlink-扩展字段)
- [预定义 QoS 配置](#预定义-qos-配置)
- [各通信模型的 QoS 设置方式](#各通信模型的-qos-设置方式)
- [DDS 后端特定说明](#dds-后端特定说明)
- [完整代码示例](#完整代码示例)
