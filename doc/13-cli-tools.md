...
| Zenoh          | `VLINK_ZENOH_*`（30 项，含 `_SHM*` 系列，详见 [21-environment-vars.md](21-environment-vars.md#zenoh)） | `VLINK_SUPPORT_ZENOH`                          |
