...
本示例集共包含 **14 个分类目录**、**84 个独立示例工程**，全部可编译运行。
...
| `security_custom` | 自定义安全密钥 -- set_security_key() 设置对称密钥 |
...
| 共享内存 | `shm://` | `iox-roudi`（Iceoryx RouDi 守护进程） | Iceoryx | `vlink::shm` |
