...
## 9. await_graph -- 等待 GraphTask DAG 完成
...
## 10. 任务编排：when_all / when_any / sequence
...
### 错误 1：协程 lambda 当临时对象用（见上文"致命陷阱"）

### 错误 2：在 loop 线程上同步 `fut.get()`
