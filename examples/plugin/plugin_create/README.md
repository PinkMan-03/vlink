...
### 4.2 VLINK_PLUGIN_DECLARE 中的 static_assert
...
## 9. VLINK_PLUGIN_REGISTER 与 VLINK_PLUGIN_REGISTER_BY_ID
...
### 10.2 VLINK_PLUGIN_DECLARE 放在可执行文件中
