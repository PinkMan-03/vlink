...
void DdsSubscriberImpl::set_latency_and_lost_enabled(bool enable) { is_latency_and_lost_enabled_ = enable; }

bool DdsSubscriberImpl::is_latency_and_lost_enabled() const { return is_latency_and_lost_enabled_; }
